      ...
      <section className="py-20 lg:py-28 bg-section-alt overflow-hidden">
        <div className="container-custom">
          ...
          <div className="relative overflow-hidden py-10">
            ...
            <motion.div
              className="flex gap-8 md:gap-16 min-w-max px-4"
              animate={{ x: ["0%", "-50%"] }}
              transition={{
                duration: 40,
                ease: "linear",
            ...
            >
              {[...journeyMilestones, ...journeyMilestones].map((milestone, index) => (
                <div
                  key={`${milestone.year}-${index}`}
                  className="relative w-80 md:w-96 flex-shrink-0 group"
                >
                  {/* Central Dot */}
                  ...
                  {/* Connector Line */}
                  <div
                    className={`absolute left-1/2 -translate-x-1/2 w-0.5 bg-primary/30
                  ...
                  >
                    <div
                      className="bg-background rounded-xl p-6 shadow-md border border-border/50 hover:shadow-xl transition-all hover:scale-105 cursor-pointer relative"
                    >
                      {/* Year Badge */}
